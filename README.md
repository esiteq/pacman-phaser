...
- **Гра іноді виглядає обрізаною знизу/зверху на конкретних вікнах браузера**
  користувача, попри те що це не відтворюється в headless Chrome-тестах на
  тих самих піксельних розмірах вікна (перевірено багато разів, включно з
  точним відтворенням розміру вікна з наданих скріншотів — canvas центрується
  і має відступ з усіх боків у кожному тесті). Причина поки не встановлена:
  можливо, специфіка конкретного браузера/масштабування екрана/DPI на
  стороні користувача, яку не вдалось відтворити віддалено. Діагностику
  відкладено на прохання користувача — деталі розслідування в
  `DEVELOPMENT_LOG.md` (сесія 6).
