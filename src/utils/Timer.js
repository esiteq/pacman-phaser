// Direct port of app/scripts/utilities/timer.js from bward2/pacman-js.
// A pausable setTimeout wrapper. Fires window CustomEvents so GameScene can
// track every live timer in `activeTimers`, exactly like the original.
export default class Timer {
  ...
  /**
   * Pauses the timer and marks whether the pause came from the player
   * or the system
